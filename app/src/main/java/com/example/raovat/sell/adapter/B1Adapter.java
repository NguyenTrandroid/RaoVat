...
public class B1Adapter extends RecyclerView.Adapter<B1Adapter.ViewHolder> {
    ...
    public B1Adapter(OnSelectCategrory onSelectCategrory, Context context, ArrayList<CategoryParents> list) {
    ...
    @NonNull
    @Override
    public B1Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_sell, parent, false);
        return new B1Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull B1Adapter.ViewHolder holder, final int position) {
